...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-117594980-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-117594980-1');
</script>
...
<div class="fax"><span style="font-size: 11pt;">Тел/факс</span></div>
